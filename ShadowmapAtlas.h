...
namespace AZ
{
    namespace Render
    {
        ...
        static const ShadowmapSize MinShadowmapImageSize = ShadowmapSize::Size256;
        static const ShadowmapSize MaxShadowmapImageSize = ShadowmapSize::Size2048;
        ...
        public:
            ...
            struct Origin
            {
                ...
                std::array<uint32_t, 2> m_originInSlice{ {0, 0} };
            };
            ...
            /*Data::Instance<RPI::Buffer>*/ void *CreateShadowmapIndexTableBuffer(const std::string& bufferName) const;

            const std::vector<ShadowmapIndexNode>& GetShadowmapIndexTable() const;
        ...
        private:
            ...
            using Location = std::vector<uint8_t>;
            ...
            struct LocationHasher
            {
                ...
                result_type operator()(const argument_type& value) const
                {
                    ...
                    return 0;
                    //return std::hash_range(buffer, buffer + value.size() * sizeof(uint8_t));
                }
            };
            ...
            using ShadowmapIndicesInNode = std::vector<size_t>;
            ...
            std::unordered_map<ShadowmapSize, std::list<size_t>> m_indicesForSize;
            std::vector<ShadowmapIndexNode> m_indexTableData;

            std::unordered_map<size_t, Location> m_locations;
            std::unordered_map<Location, ShadowmapIndicesInNode, LocationHasher> m_shadowmapIndexNodeTree;
        };
